    ...
    function getDivvyData(date) {
            ...
            xmlhttp.onreadystatechange = function() {
                if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                    ...
                    document.getElementById('infobox').innerHTML = '<iframe sandbox="allow-same-origin allow-scripts allow-popups allow-forms" src="chord.html" width="400px" height="400px" allowtransparency="true" style="overflow:hidden;-webkit-transform:translate3d(0,0,0);" scrolling="no" id="divvyChord" frameBorder="0">';
